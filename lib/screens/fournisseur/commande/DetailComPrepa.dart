...
class DetailComPrepaFournisseur extends StatefulWidget {
  const DetailComPrepaFournisseur({Key? key}) : super(key: key);

  @override
  State<DetailComPrepaFournisseur> createState() => _DetailComPrepaFournisseurState();
}

class _DetailComPrepaFournisseurState extends State<DetailComPrepaFournisseur> {
  @override
