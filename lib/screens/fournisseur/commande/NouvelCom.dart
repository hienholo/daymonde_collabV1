...
class NouvelComFournisseur extends StatefulWidget {
 const NouvelComFournisseur({Key? key}) : super(key: key);

  @override
  State<NouvelComFournisseur> createState() => _NouvelComFournisseurState();
}

class _NouvelComFournisseurState extends State<NouvelComFournisseur> {
  @override
                      ...
                      child: SizedBox(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, i) {
                              ...
                              onTap:() {Navigator.push(context, MaterialPageRoute(builder: (context)=>const NouvelComDetailFournisseur()));} 
                    ),
                  ),
                ),
    );
