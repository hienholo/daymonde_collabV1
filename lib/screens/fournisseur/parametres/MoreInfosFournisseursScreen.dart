...
class MoreInfosAmbassadeurScreen extends StatefulWidget {
  const MoreInfosAmbassadeurScreen({Key? key,}) : super(key: key);

  @override
  _MoreInfosAmbassadeurScreenState createState() => _MoreInfosAmbassadeurScreenState();
}

class _MoreInfosAmbassadeurScreenState extends State<MoreInfosAmbassadeurScreen> {
                      ...
                      ExpansionPanel(
                        ...
                        headerBuilder: (context, isExpanded) {
                          return Container(
                            ...
                            child: const Padding(
                              padding: EdgeInsets.all(30.0),
                              child: Text("Fonctionnalité ambassadeur", style: TextStyle(color: Colors.black,fontSize: 20),),
                            ),
                          );
                        },
                        body:SingleChildScrollView(
                      ...
                      ExpansionPanel(
                        ...
                        headerBuilder: (context, isExpanded1) {
                          return Container(
                            ...
                            child: const Padding(
                              padding: EdgeInsets.all(30.0),
                              child: Text("Comment être rémunéré ", style: TextStyle(color: Colors.black,fontSize: 20),),
                            ),
                          );
                        },
                        body:SingleChildScrollView(
                      ...
                      ExpansionPanel(
                        ...
                        headerBuilder: (context, isExpanded1) {
                          return Container(
                            ...
                            child: const Padding(
                              padding: EdgeInsets.all(30.0),
                              child: Text("Tableau des gains", style: TextStyle(color: Colors.black,fontSize: 20),),
                            ),
                          );
                        },
                        body:SingleChildScrollView(
