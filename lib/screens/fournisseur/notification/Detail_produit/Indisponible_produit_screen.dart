...
class ProduitIndisponibleScreen extends StatefulWidget {
  const ProduitIndisponibleScreen({super.key ,required this.ID_PRODUCT});
  final ID_PRODUCT;
  @override
  State<ProduitIndisponibleScreen> createState() =>
      _ProduitIndisponibleScreenState();
}
...
class _ProduitIndisponibleScreenState extends State<ProduitIndisponibleScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FournisseurBottomNavBar(selectedIndex : 3,ID_PRODUCT: widget.ID_PRODUCT,),
    );
  }
}
