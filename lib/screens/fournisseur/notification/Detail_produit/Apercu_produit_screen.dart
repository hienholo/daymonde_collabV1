...
class ApercuProduitScreen extends StatefulWidget {
  const ApercuProduitScreen({super.key, required this.ID_PRODUCT});
final ID_PRODUCT;
  @override
  State<ApercuProduitScreen> createState() => _ApercuProduitScreenState();
}
...
class _ApercuProduitScreenState extends State<ApercuProduitScreen> {
  /////////////////////// GET PRODUITS BY ID ///////
...
//multiple images
      ...
      bottomNavigationBar: FournisseurBottomNavBar(selectedIndex : 0,ID_PRODUCT : widget.ID_PRODUCT),
    );
  }
}
